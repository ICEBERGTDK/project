##############################
# These are the COVID-19 for United Kingdom
#############################
...
mtext(outer = TRUE, side = 3, "SEIR 30 days post introduction", cex = 1.5)

out_1[time=31,]/N                 # Percentages of each class after introduction
(100 - (out_1[time=31,]/N)[2])    # The Percent of cumulative number of infected individuals at the end of the epidemic
(1 - (out_1[time=31,]/N)[2])*N        # cumulative number of infected individuals at the end of the epidemic
...
plot(out_1, xlab = "time (days)", ylab = "Number of individuals")
plot(out_1[, "Susceptible"], out_1[, "Infected"], pch = ".",ylab="Infected",xlab="Susceptibles")
mtext(outer = TRUE, side = 3, "SEIR 60 days post introduction", cex = 1.5)

out_1[time=61,]/N                 # Percentages of each class after introduction
(100 - (out_1[time=61,]/N)[2])    # The Percent of cumulative number of infected individuals at the end of the epidemic
(1 - (out_1[time=61,]/N)[2])*N        # cumulative number of infected individuals at the end of the epidemic
...
out_m_1[time=31,]/N
(100 - (out_m_1[time=31,]/N)[2]) 
(1 - (out_m_1[time=31,]/N)[2])*N 
...
out_m_1[time=61,]/N
(100 - (out_m_1[time=61,]/N)[2]) 
(1 - (out_m_1[time=61,]/N)[2])*N 
